...
namespace FBS.XF.Toolkit.Controls
{
	...
	/// </remarks>
	public class RepeaterViewTest : StackLayout, IDisposable
	{
		#region Constructor methods
		/// <summary>
		/// Initializes a new instance of the <see cref="RepeaterViewTest"/> class.
		/// </summary>
		public RepeaterViewTest()
		{
			Spacing = 0;
			Padding = 0;
		}
		...
		public static readonly BindableProperty BackgroundColorSelectedProperty =
			BindableProperty.Create(nameof(BackgroundColorSelected), typeof(Color), typeof(RepeaterViewTest), Color.Default,
				propertyChanged: (bd, ov, nv) => ((RepeaterViewTest) bd).ControlPropertyChanged(ov, nv));

		/// <summary>
		/// The items source property
		/// </summary>
		public static readonly BindableProperty ItemsSourceProperty =
			BindableProperty.Create(nameof(ItemsSource), typeof(object), typeof(RepeaterViewTest),
				propertyChanged: (bd, ov, nv) => ((RepeaterViewTest) bd).ControlPropertyChanged(ov, nv));
		...
		public static readonly BindableProperty ItemTemplateProperty =
			BindableProperty.Create(nameof(ItemTemplate), typeof(DataTemplate), typeof(RepeaterViewTest),
				propertyChanged: (bd, ov, nv) => ((RepeaterViewTest) bd).ControlPropertyChanged(ov, nv));
		...
		public static readonly BindableProperty RepeatCountProperty =
			BindableProperty.Create(nameof(RepeatCount), typeof(int), typeof(RepeaterViewTest),
				propertyChanged: (bd, ov, nv) => ((RepeaterViewTest) bd).ControlPropertyChanged(ov, nv));
		...
		public static readonly BindableProperty RepeatVisibilityProperty =
			BindableProperty.Create(nameof(RepeatVisibility), typeof(RepeatVisibilityMode), typeof(RepeaterViewTest),
		...
		public static readonly BindableProperty SelectedIndexProperty =
			BindableProperty.Create(nameof(SelectedIndex), typeof(int), typeof(RepeaterViewTest), -1, BindingMode.TwoWay,
				propertyChanged: (bd, ov, nv) => ((RepeaterViewTest) bd).SelectedItemPropertyChanged(ov, nv));

		/// <summary>
		/// The selected item property
		/// </summary>
		public static readonly BindableProperty SelectedItemProperty =
			BindableProperty.Create(nameof(SelectedItem), typeof(object), typeof(RepeaterViewTest),
		...
		public static readonly BindableProperty SelectionModeProperty =
			BindableProperty.Create(nameof(SelectionMode), typeof(SelectionMode), typeof(RepeaterViewTest), SelectionMode.Single);

		/// <summary>
		/// The selected text color property
		/// </summary>
		public static readonly BindableProperty SelectedTextColorProperty =
			BindableProperty.Create(nameof(SelectedTextColor), typeof(Color), typeof(RepeaterViewTest), Color.Default);

		/// <summary>
		/// The separator property
		/// </summary>
		public static readonly BindableProperty SeparatorProperty =
			BindableProperty.Create(nameof(Separator), typeof(string), typeof(RepeaterViewTest),
				propertyChanged: (bd, ov, nv) => ((RepeaterViewTest) bd).ControlPropertyChanged(ov, nv));
		...
		public static readonly BindableProperty SeparatorTemplateProperty =
			BindableProperty.Create(nameof(SeparatorTemplate), typeof(DataTemplate), typeof(RepeaterViewTest),
				propertyChanged: (bd, ov, nv) => ((RepeaterViewTest) bd).ControlPropertyChanged(ov, nv));
		...
		public static readonly BindableProperty TextColorProperty =
			BindableProperty.Create(nameof(TextColor), typeof(Color), typeof(RepeaterViewTest), Color.Default);

		/// <summary>
		/// The tag property
		/// </summary>
		public static readonly BindableProperty TagProperty =
			BindableProperty.Create(nameof(Tag), typeof(string), typeof(RepeaterViewTest));
		#endregion
